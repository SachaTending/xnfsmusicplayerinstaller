...
#define BOOTFLOW_ADDRESS 0x008F3C58
...
#define EASXTOOLMESSAGE "Decoding ASFs to WAV with Sound eXchange..."
...
#define OGGENCODINGFORMATTER "Encoding WAVs to OGG with %f quality..."
